...
UInt32 hash_adler32(void const* data, Ull len);

UInt32 hash_crc32(void const* data, Ull len);
UInt64 hash_crc64(void const* data, Ull len);

UInt32 hash_fnv32 (void const* data, Ull len);
UInt64 hash_fnv64 (void const* data, Ull len);
UInt32 hash_fnv32a(void const* data, Ull len);
...
UInt32 hash_murmur32_seed(void const* data, Ull len, UInt32 seed);
UInt64 hash_murmur64_seed(void const* data, Ull len, UInt64 seed);
...
UInt64 hash_murmur64_seed(void const* data_, Ll len, UInt64 seed) {
    ...
    UInt64 const* data = cast(UInt64 const* )data_;
