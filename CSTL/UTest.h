...
#include <mach/mach_time.h>
    ...
    #define CSTL_INITIALIZER(f)                                                   \
        ...
        __pragma(comment(linker, "/include:" CSTL_SYMBOL_PREFIX #f "_"))            \
            CSTL_C_FUNC __declspec(allocate(".CRT$XCU")) void(__cdecl *             \
                                                                f##_)(void) = f;      \
...
/*
    ...
    */
...
#ifdef _MSC_VER
    #define CSTL_SURPRESS_WARNING_BEGIN                                           \
    __pragma(warning(push)) __pragma(warning(disable : 4127))
    #define CSTL_SURPRESS_WARNING_END __pragma(warning(pop))
#else
    #define CSTL_SURPRESS_WARNING_BEGIN
    #define CSTL_SURPRESS_WARNING_END
#endif
    ...
    CSTL_SURPRESS_WARNING_BEGIN do {                                            \
...
*/
#define CSTL_STATE()    struct cstl_utest_state_s cstl_utest_state = {0, 0, 0}
